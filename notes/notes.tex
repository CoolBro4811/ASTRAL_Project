...
https://en.wikipedia.org/wiki/Point\_spread\_function
...
%p\_hi = np.percentile(img\_sub, 99.5)
%p\_lo = np.percentile(img\_sub, 0.5)
...
https://en.wikipedia.org/wiki/Matched\_filter

currently just like taking the mad stddev but idk????
Median Absolute Deviation
https://en.wikipedia.org/wiki/Median\_absolute\_deviation
